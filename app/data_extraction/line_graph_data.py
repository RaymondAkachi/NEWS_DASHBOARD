...
async def get_daily_avg_sentiment_last_month(days: int = 30, category: str | None = None) -> dict[str, float]:
    """
...
if __name__ == "__main__":
    ...
    async def test():
        daily_all = await get_daily_avg_sentiment_last_month()
        print(daily_all)

        # Last-month sentiment for “Business”
        daily_business = await get_daily_avg_sentiment_last_month("Business")
